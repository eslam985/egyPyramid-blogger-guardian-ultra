<template>
    ...
    <div class="media-details-container" v-if="mediaData.title">
            ...
            <div class="info-side">
                <div class="edit-form-container">
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="mediaData.story" class="form-control textarea"></textarea>
                    </div>
        ...
        <div class="episodes-section">
            ...
            <div class="episodes-grid" v-if="mediaData.episodes && mediaData.episodes.length > 0">
                <div v-for="ep in mediaData.episodes" :key="ep.id" class="ep-card">
...
const syncToBlogger = async (ep) => {
    ...
    if (res.data.status === 'success') ep.is_synced = true;
};
